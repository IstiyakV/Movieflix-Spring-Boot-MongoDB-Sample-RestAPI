...
import me.isty.movieflix.Repositories.ReviewRepository;
...
public class ReviewService {
    @Autowired
    private ReviewRepository reveReviewRepository;
    @Autowired
    private MongoTemplate mongoTemplate;
    public Review createReview(String reviewBody,String imdbId){
        Review review = reveReviewRepository.insert(new Review(reviewBody));
